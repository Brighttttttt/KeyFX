            ...
            <div>
                <div className={`grid lg:grid-cols-2 grid-cols-1 gap-24 ${isMobile ? 'mt-10' : ' mt-36'} `}>
                    <div className='lg:order-1 order-2'>
                        ...
                        <p className='roboto fw600 text700' style={{fontSize: '36px', marginTop: '30px'}}>Payment
                            Services</p>
                        ...
                        <p className='mt-3 text500' style={{fontSize: '16px'}}>Streamline your cross-border transactions
                            on one
                ...
                <div className={`grid lg:grid-cols-2 grid-cols-1 gap-24  mt-36 `}>
                    ...
                    <div>
                        ...
                        <p className='roboto fw600 text700' style={{fontSize: '36px', marginTop: '30px'}}>Foreign
                            Exchange
                            Services</p>
                        <ul className={`${isMobile ? 'aqua-list' : 'blue-list'} mt-4`}>
                ...
                <div className={`grid lg:grid-cols-2 grid-cols-1 gap-24 ${isMobile ? 'mt-0' : 'mt-36'} `}>
                    <div className='lg:order-1 order-2	'>
                        ...
                        <p className='roboto fw600 text700' style={{fontSize: '36px', marginTop: '30px'}}>Card
                            Services</p>
                        <ul className={`${isMobile ? 'aqua-list' : 'blue-list'} mt-4`}>
                ...
                <div className={`grid lg:grid-cols-2 grid-cols-1 gap-20  ${isMobile ? 'mt-0' : 'mt-36'}  `}>
                    ...
                    <div>
                        ...
                        <p className='roboto fw600 text700 localBusiness'
                           style={{fontSize: '36px', marginTop: '30px'}}>Local Business Bank
                            Accounts</p>
                        ...
                        <p className='mt-3 text500' style={{fontSize: '16px'}}>Operate your business like a local on a
                            global scale

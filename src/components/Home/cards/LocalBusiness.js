        ...
        <ul className='cstomUl'>
          ...
          >
            ...
            <a className='child1 flex justify-center flex-col items-center gap-3'>
              ...
              <p className='font-bold roboto text700 w-3/4' style={{fontSize: "16px"}}>Local Business Bank Accounts</p>
            ...
            <ul className='relative'>
              ...
              <div className="flow">
                <svg width="271" height="194" viewBox="0 0 271 194" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                  ...
                  <path d="M136 31V194" stroke="url(#flowing-gradient)" strokeWidth="3" className="flowing-gradient"/>
                  <path
              ...
              <li className=''>
                <a className='child2 flex items-center'>
                  <input className={`check-lcb ${isHovered ? 'custom-checkbox' : ''}`} checked={isHovered}
                         type='checkbox'/>

        ...
        <div className={"py-20"}>
            <div className={"text-center"}>
                ...
                <Input placeholder={"Search for app &..."} startContent={<img src={searchIcon} alt="Search Icon"/>}
                       className={"w-[872px] mx-auto mt-6"}
                       classNames={{
            ...
            <div className={"mt-20 w-[872px] mx-auto"}>
...
function AccordionItemGenerator({id, title, description, selected, setSelected}) {
    ...
    return (
        <div
            className={`relative z-20 overflow-hidden transition-all cursor-pointer ${isOpen ? "bg-white border border-solid border-[#D5DAEF] shadow-[inset_0px_-2px_10px_0px_#3e6f9f40,0px_30px_50px_-30px_#4a4a4a1a,0px_30px_70px_-20px_#32325d26]" : ""}  p-8 rounded-xl`}
